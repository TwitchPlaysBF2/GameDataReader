using GameDataReader.Battlefield2.Files;
...
{
    private readonly GlobalBf2ConfigFile _globalConfig;
    private ProfileBf2ConfigFile? _profileConfig;

    public Bf2DataReader()
    {
        _globalConfig = new GlobalBf2ConfigFile();
    }
    ...
    public Bf2Player ReadActivePlayer()
    {
        ...
        _profileConfig = new ProfileBf2ConfigFile(activeProfileNumber);
